...
**the agent passport page**

A shareable public passport for you or your agent. Ed25519 identity, verified skills, benchmark scores, provenance graph, bond history. One HTML file. Yours to fork, host, or run from disk.

- Live: **https://sjgant80-hub.github.io/fallprofile/**
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=fallprofile](https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallprofile)
...
- **Companion SDK** (`npm install @ai-native-solutions/fallprofile-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add fallprofile -- npx -y @ai-native-solutions/fallprofile-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/fallprofile-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=fallprofile
- **Live URL**: https://sjgant80-hub.github.io/fallprofile/
- **Source**: https://github.com/sjgant80-hub/fallprofile
- **Machine summary**: [llms.txt](llms.txt)
- **License**: MIT
